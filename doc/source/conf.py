...
htmlhelp_basename = 'MoleculeKitdoc'
...
latex_documents = [
  (master_doc, 'moleculekit.tex', 'MoleculeKit Documentation',
   'Stefan Doerr', 'manual'),
]
...
man_pages = [
    (master_doc, 'moleculekit', 'MoleculeKit Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'moleculekit', 'MoleculeKit Documentation',
   author, 'moleculekit', 'One line description of project.',
   'Miscellaneous'),
]
