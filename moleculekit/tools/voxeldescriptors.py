...
def viewVoxelFeatures(features, centers, nvoxels, voxelsize=None, feature_names=_order, draw='wireframe'):
    ...
    features = features.reshape(list(nvoxels) + [len(feature_names),])
