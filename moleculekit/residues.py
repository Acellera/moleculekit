...
MODIFIED_PROTEIN_RESIDUES = (
    ...
    _Residue(
        full_name="S-Hydroxycysteine",
        resname="CSO",
        single_letter="C",
        resname_variants=[],
    ),
    _Residue(
        full_name="S-Mercaptocysteine",
        resname="CSS",
        single_letter="C",
        resname_variants=[],
    ),
    _Residue(
        full_name="Pyroglutamic acid",
        resname="PCA",
        single_letter="Q",
        resname_variants=[],
    ),
    _Residue(
        full_name="Dimethylarginine",
        resname="2MR",
        single_letter="R",
        resname_variants=[],
    ),
    _Residue(
        full_name="Gamma-Carboxyglutamate",
        resname="CGU",
        single_letter="E",
        resname_variants=[],
    ),
...
MODIFIED_NUCLEIC_RESIDUES = (
    ...
    _Residue(
        full_name="Pseudouridine", resname="PSU", single_letter="U", resname_variants=[]
    ),
    _Residue(
        full_name="5-Methyluridine",
        resname="5MU",
        single_letter="U",
        resname_variants=[],
    ),
